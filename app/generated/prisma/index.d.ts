...
export namespace Prisma {
  ...
  */
    ...
    model: {
      UserModel: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.UserModelFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.UserModelAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserModelOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "email" | "name", ExtArgs["result"]["userModel"]>
  ...
  export interface UserModelDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more UserModels that matches the filter.
     * @param {UserModelFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const userModel = await prisma.userModel.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: UserModelFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a UserModel.
     * @param {UserModelAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const userModel = await prisma.userModel.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: UserModelAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
   ...
   * UserModel findRaw
   */
  export type UserModelFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  /**
   * UserModel aggregateRaw
   */
  export type UserModelAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
